...
[![Version](https://img.shields.io/badge/Version-v0.6.4-blue)](https://github.com/tamada/plmaker/releases/tag/v${VERSION)
[![License](https://img.shields.io/badge/License-Apache--2.0-blue)](https://github.com/tamada/plmaker/blob/main/LICENSE)

![Docker](https://img.shields.io/static/v1?label=Docker&message=ghcr.io/tamada/plmaker/native:0.6.4&color=green&logo=docker)
![Docker](https://img.shields.io/static/v1?label=Docker&message=ghcr.io/tamada/plmaker/java:0.6.4&color=green&logo=docker)
...
```shell
docker run -it --rm -v $PWD:/app ghcr.io/tamada/plmaker/native:0.6.4 <ARGUMENTS_FOR_PLMAKER>
```
...
Type the following commands, then `build/libs/plmaker-0.6.4.jar` will be built.
